...
This project transpiles the specification to the Java programming language, under the assumption that it is allowed usage under the following principle in their [Intellectual Property | openehr.org](https://openehr.org/governance/intellectual_property) notice:
